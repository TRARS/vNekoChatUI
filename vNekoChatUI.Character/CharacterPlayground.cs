...
namespace vNekoChatUI.Character
{
    public partial class CharacterPlayground
    {
        ...
        /// </summary>
        public ChatClientWapper CreateChatClient(string _name,
                                                 bool _autoReply,
                                                 ...
                                                 Func<SenderInfo> _getUserProfileCallBack)
        {
            ...
            //返回该用户的客户端（没有防呆
            return new ChatClientWapper(_name, _autoReply, serverIP, serverPort,
                                        _autoReplyCallBack,
    ...
    public partial class CharacterPlayground
    {
        public SenderInfo FindOnlineUserByName(string userName)
        {
            ...
            //可能是匿名用户
            return new SenderInfo("Anonymous", "#FF0000", string.Empty, true);
        }
    }
}
