...
namespace Common
{
    public sealed partial class SharpTokenProxy
    {
        private static readonly object objlock = new object();
        private static SharpTokenProxy? _instance;
        public static SharpTokenProxy Instance
        {
            get
            {
                lock (objlock)
    ...
    public sealed partial class SharpTokenProxy
    {
        ...
        /// </summary>
        /// <returns></returns>
        public (int, string, string) tiktoken_consumption(string input_str, string model_str = encodingName)
        {
