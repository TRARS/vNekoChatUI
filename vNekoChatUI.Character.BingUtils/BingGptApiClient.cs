...
namespace vNekoChatUI.Character.BingUtils.Services
{
    ...
    public sealed partial class BingGptApiClient
    {
        ...
        internal async Task<Bing_Response?> WaitReplyAsync(BingRequest message, CancellationToken cancellationToken, Action<int> stepUp)
        {
            return await _bingChatClient.WaitReplyAsync(message, cancellationToken, stepUp);
        }
    }
}
