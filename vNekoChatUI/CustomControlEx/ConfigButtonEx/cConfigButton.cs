...
namespace vNekoChatUI.CustomControlEx.ConfigButtonEx
{
    ...
    public partial class cConfigButton
    {
        ...
        public UserControlEx.ClientEx.RelayCommand AddBingGptCookieCommand
        {
            get { return (UserControlEx.ClientEx.RelayCommand)GetValue(AddBingGptCookieCommandProperty); }
