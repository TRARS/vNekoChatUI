...
namespace vNekoChatUI.CustomControlEx.SuggestionMenuItemEx
{
    ...
    public partial class cSuggestionMenuItem
    {
        ...
        public UserControlEx.ClientEx.RelayCommand SelectSuggestionCommand
        {
            get { return (UserControlEx.ClientEx.RelayCommand)GetValue(SelectSuggestionCommandProperty); }
